                    ...
                    <div class="modal-dialog cmw modal-dialog-scrollable d-flex justify-content-center">
                        <div class="modal-content">
                            ...
                            <div class="modal-body p-4">
                                <form wire:submit.prevent='addEmployer()' enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <!-- Name input -->
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="file" id="photo" name="photo"
                                                    class="form-control" wire:model.live="photo"  />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                            ...
                                            <td style="width: 200px;">
                                                <div class="btn-group">
                                                    <button type="button" class="btn btn-warning"
                                                        style="color: white;">Action</button>
                                                    <button type="button" class="btn btn-warning dropdown-toggle"
                                                        style="color: white;" data-toggle="dropdown">
                                                        <span class="sr-only">Toggle Dropdown</span>
                                                    </button>
                                                    <div class="dropdown-menu" role="menu">
                                                        <a class="dropdown-item"
                                                            href="/admin/profile/{{ $Emp->id }}">Afficher</a>
                                                        <a class="dropdown-item cursour-pointer" href="#"
                                                            wire:click.prevent='supprimer({{ $Emp->id }})'>supprimer</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
